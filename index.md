...
venue: "Claremont McKenna College"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room RN12, Roberts Hall North 320 E 9th St, Claremont, CA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/ISO_639-1)
latlng: "34.1024,-117.7106"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Feb 22-23, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Friday 12:00 - 8:00 pm, Saturday 8:00 am - 5:00pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
email: ["jfossota@colby.edu","timlwarren@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-02-22-claremont            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite:  "55099263380"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<div id="python"> {% comment %} Start of 'Python' section. Remove the third paragraph if
  ...
  <p><strong>
  Finally, please download the following software
